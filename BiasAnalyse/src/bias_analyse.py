...
#
# Created: Thu Sep 19 13:52:34 2013
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1291, 732)
        self.centralwidget = QtGui.QWidget(MainWindow)
        self.centralwidget.setObjectName(_fromUtf8("centralwidget"))
        self.treeView = QtGui.QTreeView(self.centralwidget)
        self.treeView.setGeometry(QtCore.QRect(10, 10, 451, 271))
        self.treeView.setObjectName(_fromUtf8("treeView"))
        self.tabWidget = QtGui.QTabWidget(self.centralwidget)
        self.tabWidget.setGeometry(QtCore.QRect(10, 290, 451, 401))
        ...
        self.statTable.setGeometry(QtCore.QRect(10, 10, 421, 261))
        ...
        self.widget = QtGui.QWidget(self.runstatTab)
        self.widget.setGeometry(QtCore.QRect(10, 240, 361, 111))
        ...
        self.current_v_on = QtGui.QLineEdit(self.widget)
        ...
        self.voltage_i_on = QtGui.QLineEdit(self.widget)
